...
class Simulator:
    ...
    def simulate(self, duration=None, fig_directory="res/simulator"):
        ...
        if self.generate_graphs:
            ...
            print(suffix)
            pickle.dump(result, open(f'data/nore/result_{suffix}.pkl', 'wb'))
            pickle.dump(instances_xs, open(f'data/nore/instances_xs_{suffix}.pkl', 'wb'))
            pickle.dump(instances_ys, open(f'data/nore/instances_ys_{suffix}.pkl', 'wb'))
            pickle.dump(self.performance_xs, open(f'data/nore/performance_xs_{suffix}.pkl', 'wb'))
            pickle.dump(self.performance_ys, open(f'data/nore/performance_ys_{suffix}.pkl', 'wb'))
